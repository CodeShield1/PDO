        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <?php if (!empty($recipe['image'])): ?>
                    <img src="../images/<?= htmlspecialchars($recipe['image']) ?>" alt="Actuelle" style="width: 100px; height: 100px; object-fit: cover; border-radius: 8px; margin-bottom: 10px; display: block; border: 1px solid var(--border);">
                <?php endif; ?>
